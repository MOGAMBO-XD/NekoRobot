...
buttons = [
    ...
    [
        InlineKeyboardButton(text="📰 ᴜᴘᴅᴀᴛᴇꜱ", url=f"https://t.me/StrawhatUpdates"),
...
def Fallen_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "fallen_":
        ...
        query.message.edit_text(
            ...
            "\n*A powerful group management bot built to help you manage your precious group easily and to protect your group from scammers and spammers.*"
            ...
            f"\n\n➻ Click on the button given below for getting basic help and info about {BOT_NAME}.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="🔙 ʙᴀᴄᴋ", callback_data="fallen_back"
                        ),
                    ],
                ]
            ),
        ...
        query.message.edit_text(
            text="*๏ Click on the button given below to get help and more information about me.*"
            f"\n\nIf you found any bug in {BOT_NAME} or if you wanna give feedback related to {BOT_NAME}, please report it at support chat.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/StrawhatUpdates"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
