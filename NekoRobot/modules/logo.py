...
from NekoRobot import OWNER_ID, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./NekoRobot/resources/fonts/*")
        ...
        await telethn.send_file(
            event.chat_id, file=fname, caption=f"ʟᴏɢᴏ ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ɴᴇᴋᴏ ʀᴏʙᴏᴛ"
        )
        await pesan.delete()
